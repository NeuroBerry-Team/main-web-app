<template>
  ...
  <header class="fixed w-full" style="z-index: 999;">
    <nav class="bg-berry-whiteaux border-gray-200 py-2.5">
      <div class="flex flex-wrap items-center justify-between max-w-screen-xl px-4 mx-auto">
        ...
        <div id="mobile-menu-2" class="items-center justify-between hidden w-full lg:flex lg:w-auto lg:order-1">
          <ul class="flex flex-col mt-0 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
            ...
            <li>
              <a href="#infrastructure" class="block py-2 pl-3 pr-4 text-gray-700 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 lg:hover:text-berry-highlight lg:p-0 ">
  ...
  <!-- Footer -->
  <footer class="bg-berry-primary mt-10">
    <div class="max-w-screen-xl p-4 py-6 mx-auto lg:py-16 md:p-8 lg:p-10">
      <div class="grid grid-cols-1 gap-8 md:grid-cols-3 lg:grid-cols-3 place-items-center">
        <div>
      ...
      <div class="text-center">
        ...
        <ul class="flex justify-center mt-5 space-x-5">
          <li>
            <a href="#" class="text-gray-500 hover:text-berry-highlight">
